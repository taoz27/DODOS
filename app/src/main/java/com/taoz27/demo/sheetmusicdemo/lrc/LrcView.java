package com.taoz27.demo.sheetmusicdemo.lrc;
...
import com.taoz27.demo.sheetmusicdemo.lrc.LrcViewContex.Mode;
...
public class LrcView extends View implements ILrcView {
	...
	protected void onDraw(Canvas canvas) {
		...
		int linepadding = lvContex.HighlightRowTextSize + lvContex.LinePaddings;
	...
	private void initLrcView(){
		...
		lvContex.HighlightRowTextSize = textheight;
	...
	private void StartMoveAnimation(LrcRow tryselectrow, final int tryselectrowindex) {
		...
		float hightlightrowshowY = getTimeLineYPosition() + lvContex.HighlightRowTextSize / 2;
