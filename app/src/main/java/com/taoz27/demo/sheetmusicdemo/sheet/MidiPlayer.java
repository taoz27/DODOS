...
import com.taoz27.demo.sheetmusicdemo.app.PlayActivity;
...
public class MidiPlayer extends LinearLayout {
    ...
    private ImageView playButton;      /** The play/pause button */
    private ImageView stopButton;      /** The stop button */
    private ImageView fastFwdButton;   /** The fast forward button */
    ...
    public MidiPlayer(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.activity = PlayActivity.playActivity;
        LoadImages(activity);
        this.midifile = null;
        this.options = null;
        this.sheet = null;
...
//        resizeButtons(newwidth, newheight);
    ...
    void CreateButtons() {
        mainLayout=(RelativeLayout)activity.getLayoutInflater().inflate(R.layout.layout_player,this,false); 
...
//        this.addView(rewindButton);
        ...
        stopButton = (ImageView) mainLayout.findViewById(R.id.stop);
...
//        this.addView(stopButton);
        ...
        playButton = (ImageView)mainLayout.findViewById(R.id.play);
...
//        this.addView(speedText);
        ...
        speedBar = (SeekBar) mainLayout.findViewById(R.id.speed);
        speedBar.setMax(200);
        speedBar.setProgress(150);
...
//                loopBtn.setText("A");
            ...
            case 1:
//                loopBtn.setText("B");
                options.playMeasuresInLoopStart=(int)(currentPulseTime / midifile.getTime().getMeasure());
                break;
            case 2:
//                loopBtn.setText("C");
                options.playMeasuresInLoopEnd=(int)(currentPulseTime / midifile.getTime().getMeasure());
                options.playMeasuresInLoop=true;
                break;
            case 3:
//                loopBtn.setText("LOOP");
                options.playMeasuresInLoop=false;
                break;
        }
        loopV++;loopV%=4;
    }
...
//        params = (RelativeLayout.LayoutParams) speedText.getLayoutParams();
//        params.height = buttonheight;
//        speedText.setLayoutParams(params);

        params = new RelativeLayout.LayoutParams(buttonheight * 5, buttonheight);
